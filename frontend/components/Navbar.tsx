...
export function Navbar() {
  ...
  const navLinks = user ? [
    { href: '/menu', label: 'Menu', icon: '????', roles: ['student', 'staff', 'runner', 'admin'] },
    { href: '/cart', label: 'Cart', icon: '????', roles: ['student'] },
    { href: '/orders', label: 'My Orders', icon: '????', roles: ['student'] },
    { href: '/staff/orders', label: 'Orders', icon: '????', roles: ['staff', 'admin'] },
    { href: '/staff/menu', label: 'Manage Menu', icon: '????', roles: ['staff', 'admin'] },
    { href: '/runner/tasks', label: 'Deliveries', icon: '??????', roles: ['runner'] },
    { href: '/admin/reports', label: 'Reports', icon: '????', roles: ['admin'] },
    { href: '/admin/users', label: 'Users', icon: '????', roles: ['admin'] },
    { href: '/admin/menu', label: 'Categories', icon: '???????', roles: ['admin'] },
